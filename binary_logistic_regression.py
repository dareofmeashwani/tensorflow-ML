...
class model:
    ...
    def setup(self):
        ...
        with tf.name_scope('Output'):
            ...
            self.prediction = tf.round(self.logits, name='Prediction')
    ...
    def get_model(self,x,is_training):
        w=ops.get_variable('weight',[self.no_of_features,1])
        b=ops.get_variable('bais', [1,1])
        mul=tf.matmul(x,w)
        return tf.sigmoid(tf.add(mul,b))
